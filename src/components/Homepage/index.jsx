...
import HackthonCards from "./HackthonCards";
			...
			<div className="bg-black  max-w-full">
				<div className="pt-[26px] pb-[76px] px-20 justify-between flex  flex-col-reverse medium:flex-row ">
					<div className="flex flex-col medium:!w-[520px] gap-9">
						...
						>
							HackerVerse is the ultimate destination where talents, skills, and
							opportunities converge in a digital symphony.
						</Typography>
			...
			<div className="flex px-20 pt-[112px] pb-[248px] gap-[26px] relative items-center  flex-wrap">
				<div className="flex flex-col gap-[56px] w-[300px]">
					...
					<Typography
						...
						component="body-regular"
					>
						Participate in our challenges and seize the chance to win exciting
						prizes while showcasing your skills.
					</Typography>
				</div>
						...
						<div className="flex flex-col gap-[15px] pl-[16px] pt-[24px] pr-12 pb-9">
							...
							<div className="flex gap-6 flex-wrap">
								...
								<div className="flex flex-col medium:w-[272px] gap-1">
									...
									>
										Participating in challenges elevates your prospects for
										top-tier company placements. Showcase your skills, tackle
										real-world problems, and build a standout portfolio that
										attracts industry leader.
									</Typography>
								</div>
							</div>
						</div>
